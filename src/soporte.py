...
def get_data_places(municipio, categorias, distancia ,latitud, longitud, token):
    ...
    url = f"https://api.foursquare.com/v3/places/search?ll={latitud}%2C{longitud}&radius={distancia}&categories={categorias}&fields=fsq_id%2Cname%2Clocation%2Ccategories%2Cdistance&sort=DISTANCE&limit=50"
